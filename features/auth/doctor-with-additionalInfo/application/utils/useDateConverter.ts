...
type DoctorRegistrationAdditionalFormValuesWithDates =
...
export function useDateConverter(
  watch: UseFormWatch<DoctorRegistrationAdditionalFormValuesWithDates>,
  setValue: UseFormSetValue<DoctorRegistrationAdditionalFormValuesWithDates>
) {

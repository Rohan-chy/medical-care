...
//   },
//   {
//       id: '6792080f-9830-4ceb-a162-55872fd1a056',
//       name: 'Blood Pressure Monitors',
//       description: 'Devices used to measure blood pressure levels',
//       categoryId: 'c21c3de9-31f5-4e20-a87e-f5b375d120be',
//       categoryName: 'Diagnostic Equipment',
//       isActive: true,
//       baseAddress: '192.168.1.22:5139/Products',
//       imageUrl: '/56352f7f-8e3b-410e-b8b4-51416211643e.png'
//     },
// ];
...
const ShopByCategory: React.FC = () => {
  ...
  const productCategoryData = data?.data || [];
    ...
    <section style={{ fontFamily: "'Inter', sans-serif'", padding: '0 16px' }}>
      ...
      >
        <h2 style={{ fontSize: 22, fontWeight: 700, color: '#1e293b' }}>
          Shop By Category ({productCategoryData.length})
        </h2>
      ...
      >
        {productCategoryData.map((cat) => (
          <CategoryCard
            ...
            cat={cat}
            onClick={() =>
              handleNavigation(`/client/shop-by-category/${cat.id}`)
            }
          />
        ))}
      </div>
...
const CategoryCard = ({ cat, onClick }: { cat: any; onClick: () => void }) => {
  ...
  const categoryImageUrl =
    cat?.baseAddress && cat?.imageUrl
      ? `http://${cat.baseAddress}${cat.imageUrl}`
      : null;

...
import { ApprovalStatusTab } from '@/lib/requestsTabs';

const AllOrganizations = () => {
  const { open, setOpen, selectedTenant, handleEdit } =
  ...
  return (
    <main>
      ...
      <Tabs defaultValue="pending" className="mt-2">
        <Tablist tabData={ApprovalStatusTab} />

        <TabsContent value="pending">
          <AllOrganizationRequests handleEdit={handleEdit} />
        </TabsContent>

        <TabsContent value="approved">
          <AllApprovedOrganizations handleEdit={handleEdit} />
        </TabsContent>
      </Tabs>

...
import { patientProfileSchema } from '../../domain/schemas/patientProfile.schema';
  ...
  useEffect(() => {
    if (patientProfileData) {
      ...
      form.reset({
        ...
        wardNumber:
          cleanedData.wardNumber !== undefined &&
          cleanedData.wardNumber !== null
            ? String(cleanedData.wardNumber)
            : '',
                  ...
                  {mode === 'edit' && (
                    <div className="flex items-center justify-end gap-2 p-2">
                      <Button disabled={!isCurrentTabDirty} type="submit">
                        {/* <Button onClick={handleTabSubmit} disabled={!isCurrentTabDirty} type="button"> */}

    ...
    <div className="bg-white col-span-2 shadow rounded-xl p-6 flex gap-6 border border-gray-200">
      ...
      <div className="w-64 h-64 rounded overflow-hidden">
        {avatarUrl ? (
          ...
          <div className="w-full h-full flex items-center justify-center bg-gray-200 text-gray-600 text-5xl font-semibold">
            {doctorDetails.firstName?.charAt(0).toUpperCase()}
          </div>
        )}
      </div>
      ...
      <div className="space-y-2 flex-1">
        ...
        {doctorDetails?.councilRegistrationNumber && (
          <p className="text-gray-700 text-sm">
            NMC • {doctorDetails?.councilRegistrationNumber}
          </p>
        )}

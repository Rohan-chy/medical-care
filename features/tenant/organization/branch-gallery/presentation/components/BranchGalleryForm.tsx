...
import { useBranchGalleryFormHandler } from '../hooks/useBranchGalleryFormHandler';

export interface props {
  data: any;
}

const BranchGallery = ({ data }: props) => {
  const {
    open,
    setOpen,
    files,
    ...
    handleSubmit,
    loading,
  } = useBranchGalleryFormHandler(data);

  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <AppTooltip content="Upload Clinic Images">

import { useAddDoctorCategory } from '../../application/usecases/useAddDoctorCategory';
import { useUpdateDoctorCategory } from '../../application/usecases/useUpdateDoctorCategory';
import {
  categorySchema,
  categorySchemaFormValues,
  updateCategorySchema,
  updateCategorySchemaFormValues,
} from '../../domain/schema/doctorCategory.schema';

...
const ClinicDetailsPage = () => {
  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto p-4">
      ...
      {ClinicDetails.latitude && ClinicDetails.longitude ? (
        <div className="max-w-xl rounded-xl overflow-hidden border">
          <GoogleLocationPicker
            initialPosition={{
              lat: ClinicDetails.latitude,
              lng: ClinicDetails.longitude,
            }}
            onSelect={(ClinicDetails: any) => {
              console.log(ClinicDetails); // leave empty
            }}
            canEdit={false}
          />
        </div>

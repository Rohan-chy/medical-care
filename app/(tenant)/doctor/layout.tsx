    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          url: '/doctor/master/product/product-attribute',
          icon: Icons.Circle,
        },
        {
          title: 'Product Attribute Value',
          url: '/doctor/master/product/product-attribute-value',
          icon: Icons.Circle,
        },
        {
          title: 'Product Category',
          url: '/doctor/master/product/product-category',
          icon: Icons.Circle,
        },
        {
          title: 'Product',
          url: '/doctor/master/product',
          icon: Icons.Circle,
        },
      ],
    },
